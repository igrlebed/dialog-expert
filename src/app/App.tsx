...
const lazyEconomics = () => import('./components/Economics');
...
const lazySecurity = () => import('./components/Security');
  ...
  return (
    <div
      ...
      style={{
        ...
        background: 'radial-gradient(circle, rgba(0,168,79,0.04) 0%, transparent 60%)',
        filter: 'blur(30px)',
      }}
    />
  );
...
function ScrollProgress() {
  ...
  return (
    <motion.div
      ...
      style={{
        scaleX,
        background: 'linear-gradient(90deg, #00A84F 0%, #34D27B 100%)',
...
export default function App() {
  ...
  return (
    <SmoothScrollProvider lerp={0.08} wheelMultiplier={0.9} duration={1200}>
      {!preloaderDone && <Preloader onComplete={() => setPreloaderDone(true)} />}
      <div className="relative min-h-screen bg-[#050a09] font-['Onest',sans-serif] text-white/80 selection:bg-[#00A84F]/20 selection:text-white antialiased">
        <CursorGlow />
        <ScrollProgress />
        <Header />
        <main>
          ...
          <LazySection factory={lazyPainPoints} minHeight="600px" rootMargin="600px" />
          <LazySection factory={lazyEconomics} minHeight="500px" />
          <LazySection factory={lazyIncluded} minHeight="500px" />
          <LazySection factory={lazyStages} minHeight="300px" />
          <LazySection factory={lazyCases} minHeight="600px" />
          <LazySection factory={lazySecurity} minHeight="400px" />
          <LazySection factory={lazyLeadForm} minHeight="500px" />
        </main>
